...
function Homepage(){
  ...
  return(<>
     ...
     <img src="src//components//image1.jpg" alt="image 1" className=' mx-auto my-auto mix-blend-lighten w-8/12 h-auto bg-cover rounded-full get-transition' style={{ boxShadow:"0px 0px 40px rgb(103 232 249)"}} />
