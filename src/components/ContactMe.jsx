    ...
    <>
        <div className="w-[88vmin] h-max mx-auto my-10  " >
            <form onSubmit={handleSubmit(onSubmit)} className="flex w-11/12 h-full   flex-col justify-center items-center gap-5">
                ...
                <input className="w-full min-h-32 max-h-max py-3 px-2 rounded-lg text-[black] font-normal focus:bg-[#2c2e3a] focus:outline-0 border-none focus:text-white text-sm  " type="text" placeholder="Enter Your Message" {...register("Message", {
                    required: { value: true, message: "*This field is Required" }
